export const aboutData = {
  ...
  technicalDetailsText2: `I originally planned to use Tiled to create a map for the game, but this proved to be difficult without learning to use more advanced libraries. I also originally used the domain-specific scripting language, Ink, to create the game logic, but I realized early on that it didn't fit my plans for this project as well as previously thought, so I decided not to use it.`,
  storyOutlineText1: ``,
